...
export const menu: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'FITS Viewer',          to: '/fits-viewer',                authRequired: true, native: true },
    ],
  },
  {
    label: 'Info',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Camera Simulator',            to: '/camera-simulator',                  native: true },
      { label: 'Astropanel',                  to: '/astropanel',                        native: true },
      { label: 'Generate',                    to: '/generate',                          authRequired: true, native: true },
      { label: 'Focus',                       to: '/focus',                             authRequired: true, native: true },
      { label: 'Process FITS',                to: '/processing',                        authRequired: true, native: true },
      { label: 'Image Circle Helper',        to: '/image-circle',                      authRequired: true, native: true },
      { label: 'Mask Base',                   to: '/mask',                              authRequired: true, native: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Network',               to: '/network',                  authRequired: true, native: true },
      { label: 'Drives',                to: '/drives',                   authRequired: true, native: true },
      { label: 'GPIO Control',          to: '/gpio',                     authRequired: true, native: true },
